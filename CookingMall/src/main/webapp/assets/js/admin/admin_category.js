...
$(document).ready(function(){
	...
	$("#add_category2_btn").click(function(){
		...
		var category2_num = document.getElementById("category2_num").value;
		
		if(document.getElementById("category1_num").value == ""){
			alert("상위분류를 선택하세요.");
			return false;
		}
		...
		.done(function(data){
			...
			for(i = 0; i < category_data.length; i++){
				...
				str += "<td><input type='button' class='category2_" + category_data[i].num + "'value = '" + category_data[i].name + "' />"
				str += "</td>"
				str += "</tr>"
				$("#category2_print").prepend(str)
			}
	...
	$("#edit_btn").click(function(){
		var selected_category = document.getElementById("selected_category").val;
		...
		.done(function(data){
			...
			for(i = 0; i < category_data.length; i++){
				...
				str += "<td><input type='button' class='category" + category_type + "_" + category_data[i].num + "' value='" + category_data[i].name + "' />"
				str += "</td>"
				str += "</tr>"
