...
<div class="container">
        ...
        <div class="login_container" >
            ...
            <div class="signup_area">
            	<span>
                	<a class="signup" href="${pageContext.request.contextPath }/user/signup_agree">회원가입</a>
               	</span>
                <span>
                    <a class="find_pwd" href="${pageContext.request.contextPath }/user/find_pwd"> 비밀번호 찾기</a>
                </span>
            </div>
        </div>
