...
public class User {
	...
	public User(String user_id, int user_num, String user_pwd, String user_name, String user_email, String user_tel,
			String user_nickname, String user_postcode, String user_addr1, String user_addr2, Date user_birthday,
			int user_type) {
		super();
	...
	public String toString() {
		return "User [user_id=" + user_id + ", user_num=" + user_num + ", user_pwd=" + user_pwd + ", user_name="
				...
				+ user_addr2 + ", user_birthday=" + user_birthday + ", user_type=" + user_type + "]";
	}
